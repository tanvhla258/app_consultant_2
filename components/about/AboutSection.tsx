    ...
    >
      <div className="mx-auto max-w-screen-2xl px-6 md:px-10 lg:px-16">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-8 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="order-1 md:order-1 md:col-span-2 lg:order-2 lg:col-span-7 lg:flex">
            <PartnerTriptych />
          </div>
          ...
          <div className="order-3 md:order-3 md:col-span-1 lg:order-3 lg:col-span-2 lg:flex">
            <ValueCallout />
          </div>
        </div>
      </div>
